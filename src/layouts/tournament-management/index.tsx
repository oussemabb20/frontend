      ...
      <VuiBox py={3}>
        <VuiBox mb={3}>
          <VuiBox display="flex" justifyContent="space-between" alignItems="center" mb={2}>
            <VuiBox>
              <VuiTypography variant="h3" color={"var(--theme-var-655)"} fontWeight="bold">
                Tournament Management
              </VuiTypography>
              <VuiTypography variant="body2" color={"var(--theme-var-656)"}>
          ...
          {feedback && <Alert severity="info" sx={{
          mb: 2
        }}>
              {feedback}
            </Alert>}
        ...
        {tournaments.length === 0 ? <Card sx={{
        textAlign: 'center',
        p: 4
      }}>
            <IoTrophy size="64px" color="#FFD700" style={{
          marginBottom: '16px'
        }} />
            ...
            {tournaments.map(tournament => <Grid item xs={12} md={6} lg={4} key={tournament._id}>
                <Card sx={{
            height: '100%',
            display: 'flex',
            flexDirection: 'column',
            background: "var(--theme-var-657)",
            border: "var(--theme-var-658)"
          }}>
                  <CardContent sx={{
              flexGrow: 1
            }}>
                    ...
                    <Box 
                      sx={{
                        backgroundColor: "var(--theme-var-659)",
                        borderRadius: 2,
                        padding: 2,
                        mb: 2,
                        border: "1px solid var(--theme-var-660)"
                      }}
                    >
        ...
        <Menu anchorEl={actionMenuAnchor} open={Boolean(actionMenuAnchor)} onClose={closeActionMenu}>
          {selectedTournament?.status === 'draft' && <MenuItem onClick={() => handleStartTournament(selectedTournament._id)}>
              <IoPlay style={{
            marginRight: 8
          }} />
              Start Tournament
        ...
        <QuickTournamentCreator open={showCreateModal} onClose={() => setShowCreateModal(false)} onTournamentCreated={handleTournamentCreated} selectedSize={selectedSize} darkMode={darkMode} />
      </VuiBox>
      <Footer />
    </DashboardLayout>;
};
